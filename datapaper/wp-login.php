...
function retrieve_password() {
	...
	if ( empty( $_POST['user_login'] ) ) {
		...
		/**
		*
		* Code ajouter pour modifier l'authentification par sha1 dans le cas d'un mail
		*/
	...
	//	$user_data = get_user_by( 'login', trim( $login ) );
		...
		/**
		*
		* Code ajouter pour modifier l'authentification par sha1 dans le cas d'un login
		*/
		//$login = sha1($login);
