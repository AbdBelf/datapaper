...
/**
Ajout du CSS personnalisé du Plugin
**/
wp_register_style('dp-bootstratp-css_custum', plugins_url('css/my_custom_css.css', __FILE__));
...
//add_submenu_page( $parent_slug, $page_title, $menu_title, $capability, $menu_slug, $function ); 
    ...
    add_submenu_page('dp-menu-page', 'Datapaper user','Publications', 'read', 'dp-user','datapaper_user');
...
function dp_help_files() {
    ...
    wp_enqueue_style('dp-bootstratp-css_custum');
